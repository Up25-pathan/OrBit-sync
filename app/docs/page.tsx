  ...
  'local-first-sync': {
    ...
    sections: [
      ...
      },
      {
        ...
        code: '// Dead-Drop Vault API\nPOST https://orbit-server-kae6.onrender.com/api/v1/projects/:id/push\nGET  https://orbit-server-kae6.onrender.com/api/v1/projects/:id/pull',
      },
    ],
  },
